...
// Candle constructs a field with the given ZETA candle proto value.
func Candle(c fmt.Stringer) zap.Field {
	return zap.String("candle", c.String())
}

// CandleWithTag constructs a field with the given ZETA candle proto value and key equal to the tag string.
func CandleWithTag(c fmt.Stringer, tag string) zap.Field {
	return zap.String(tag, c.String())
}

// Order constructs a field with the given ZETA order value.
func Order(o fmt.Stringer) zap.Field {
	return zap.String("order", o.String())
}

// ProtoOrder constructs a field with the given ZETA order proto value.
...
// OrderWithTag constructs a field with the given ZETA order proto value and key equal to the tag string.
func OrderWithTag(o fmt.Stringer, tag string) zap.Field {
	return zap.String(tag, o.String())
}

// Trade constructs a field with the given ZETA trade proto value.
func Trade(t fmt.Stringer) zap.Field {
	return zap.String("trade", t.String())
}

// Market constructs a field with the given ZETA market proto value.
...
// Party constructs a field with the given ZETA party proto value.
...
// Account constructs a field with the given ZETA account proto value.
func Account(a fmt.Stringer) zap.Field {
	return zap.String("account", a.String())
}

// ProtoAccount constructs a field with the given ZETA account proto value.
