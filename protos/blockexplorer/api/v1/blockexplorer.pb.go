...
type Transaction struct {
	...
	// Zeta public key of the transaction's submitter
...
var file_blockexplorer_api_v1_blockexplorer_proto_goTypes = []interface{}{
	...
	(*v1.InputData)(nil),             // 8: zeta.commands.v1.InputData
	(*v1.Signature)(nil),             // 9: zeta.commands.v1.Signature
}
var file_blockexplorer_api_v1_blockexplorer_proto_depIdxs = []int32{
	...
	8, // 3: blockexplorer.api.v1.Transaction.command:type_name -> zeta.commands.v1.InputData
	9, // 4: blockexplorer.api.v1.Transaction.signature:type_name -> zeta.commands.v1.Signature
