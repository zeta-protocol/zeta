...
type TradingDataServiceClient interface {
	...
	// List key rotations
	//
	// Get a list of information about Zeta key rotations that have been performed by validator nodes
...
func _TradingDataService_GetZetaTime_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetZetaTimeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TradingDataServiceServer).GetZetaTime(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
var TradingDataService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _TradingDataService_GetZetaTime_Handler,
		},
		{
