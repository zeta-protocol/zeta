...
// 	protoc        (unknown)
// source: zeta/wallet/v1/wallet.proto
...
func (x *SubmitTransactionRequest) Reset() {
	*x = SubmitTransactionRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_zeta_wallet_v1_wallet_proto_msgTypes[0]
...
func (*SubmitTransactionRequest) Descriptor() ([]byte, []int) {
	return file_zeta_wallet_v1_wallet_proto_rawDescGZIP(), []int{0}
}
...
var File_zeta_wallet_v1_wallet_proto protoreflect.FileDescriptor

var file_zeta_wallet_v1_wallet_proto_rawDesc = []byte{
...
var file_zeta_wallet_v1_wallet_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_zeta_wallet_v1_wallet_proto_goTypes = []interface{}{
	(*SubmitTransactionRequest)(nil),          // 0: zeta.wallet.v1.SubmitTransactionRequest
	(*v1.OrderSubmission)(nil),                // 1: zeta.commands.v1.OrderSubmission
	(*v1.OrderCancellation)(nil),              // 2: zeta.commands.v1.OrderCancellation
	(*v1.OrderAmendment)(nil),                 // 3: zeta.commands.v1.OrderAmendment
	(*v1.WithdrawSubmission)(nil),             // 4: zeta.commands.v1.WithdrawSubmission
	(*v1.ProposalSubmission)(nil),             // 5: zeta.commands.v1.ProposalSubmission
	(*v1.VoteSubmission)(nil),                 // 6: zeta.commands.v1.VoteSubmission
	(*v1.LiquidityProvisionSubmission)(nil),   // 7: zeta.commands.v1.LiquidityProvisionSubmission
	(*v1.DelegateSubmission)(nil),             // 8: zeta.commands.v1.DelegateSubmission
	(*v1.UndelegateSubmission)(nil),           // 9: zeta.commands.v1.UndelegateSubmission
	(*v1.LiquidityProvisionCancellation)(nil), // 10: zeta.commands.v1.LiquidityProvisionCancellation
	(*v1.LiquidityProvisionAmendment)(nil),    // 11: zeta.commands.v1.LiquidityProvisionAmendment
	(*v1.Transfer)(nil),                       // 12: zeta.commands.v1.Transfer
	(*v1.CancelTransfer)(nil),                 // 13: zeta.commands.v1.CancelTransfer
	(*v1.AnnounceNode)(nil),                   // 14: zeta.commands.v1.AnnounceNode
	(*v1.BatchMarketInstructions)(nil),        // 15: zeta.commands.v1.BatchMarketInstructions
	(*v1.NodeVote)(nil),                       // 16: zeta.commands.v1.NodeVote
	(*v1.NodeSignature)(nil),                  // 17: zeta.commands.v1.NodeSignature
	(*v1.ChainEvent)(nil),                     // 18: zeta.commands.v1.ChainEvent
	(*v1.KeyRotateSubmission)(nil),            // 19: zeta.commands.v1.KeyRotateSubmission
	(*v1.StateVariableProposal)(nil),          // 20: zeta.commands.v1.StateVariableProposal
	(*v1.ValidatorHeartbeat)(nil),             // 21: zeta.commands.v1.ValidatorHeartbeat
	(*v1.EthereumKeyRotateSubmission)(nil),    // 22: zeta.commands.v1.EthereumKeyRotateSubmission
	(*v1.ProtocolUpgradeProposal)(nil),        // 23: zeta.commands.v1.ProtocolUpgradeProposal
	(*v1.IssueSignatures)(nil),                // 24: zeta.commands.v1.IssueSignatures
...
func init() { file_zeta_wallet_v1_wallet_proto_init() }
func file_zeta_wallet_v1_wallet_proto_init() {
	if File_zeta_wallet_v1_wallet_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_zeta_wallet_v1_wallet_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_zeta_wallet_v1_wallet_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_zeta_wallet_v1_wallet_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_zeta_wallet_v1_wallet_proto_goTypes,
		DependencyIndexes: file_zeta_wallet_v1_wallet_proto_depIdxs,
		MessageInfos:      file_zeta_wallet_v1_wallet_proto_msgTypes,
	}.Build()
	File_zeta_wallet_v1_wallet_proto = out.File
	file_zeta_wallet_v1_wallet_proto_rawDesc = nil
	file_zeta_wallet_v1_wallet_proto_goTypes = nil
	file_zeta_wallet_v1_wallet_proto_depIdxs = nil
}
