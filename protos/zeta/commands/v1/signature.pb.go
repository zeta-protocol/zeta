...
// 	protoc        (unknown)
// source: zeta/commands/v1/signature.proto
...
func (x *Signature) Reset() {
	*x = Signature{}
	if protoimpl.UnsafeEnabled {
		mi := &file_zeta_commands_v1_signature_proto_msgTypes[0]
...
func (*Signature) Descriptor() ([]byte, []int) {
	return file_zeta_commands_v1_signature_proto_rawDescGZIP(), []int{0}
}
...
var File_zeta_commands_v1_signature_proto protoreflect.FileDescriptor

var file_zeta_commands_v1_signature_proto_rawDesc = []byte{
	...
	0x72, 0x73, 0x69, 0x6f, 0x6e, 0x42, 0x33, 0x5a, 0x31, 0x63, 0x6f, 0x64, 0x65, 0x2e, 0x76, 0x65,
...
var file_zeta_commands_v1_signature_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_zeta_commands_v1_signature_proto_goTypes = []interface{}{
	(*Signature)(nil), // 0: zeta.commands.v1.Signature
}
var file_zeta_commands_v1_signature_proto_depIdxs = []int32{
...
func init() { file_zeta_commands_v1_signature_proto_init() }
func file_zeta_commands_v1_signature_proto_init() {
	if File_zeta_commands_v1_signature_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_zeta_commands_v1_signature_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_zeta_commands_v1_signature_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_zeta_commands_v1_signature_proto_goTypes,
		DependencyIndexes: file_zeta_commands_v1_signature_proto_depIdxs,
		MessageInfos:      file_zeta_commands_v1_signature_proto_msgTypes,
	}.Build()
	File_zeta_commands_v1_signature_proto = out.File
	file_zeta_commands_v1_signature_proto_rawDesc = nil
	file_zeta_commands_v1_signature_proto_goTypes = nil
	file_zeta_commands_v1_signature_proto_depIdxs = nil
}
