...
// 	protoc        (unknown)
// source: zeta/commands/v1/validator_commands.proto
...
func (NodeSignatureKind) Descriptor() protoreflect.EnumDescriptor {
	return file_zeta_commands_v1_validator_commands_proto_enumTypes[0].Descriptor()
}

func (NodeSignatureKind) Type() protoreflect.EnumType {
	return &file_zeta_commands_v1_validator_commands_proto_enumTypes[0]
}
...
func (NodeSignatureKind) EnumDescriptor() ([]byte, []int) {
	return file_zeta_commands_v1_validator_commands_proto_rawDescGZIP(), []int{0}
}
...
func (NodeVote_Type) Descriptor() protoreflect.EnumDescriptor {
	return file_zeta_commands_v1_validator_commands_proto_enumTypes[1].Descriptor()
}

func (NodeVote_Type) Type() protoreflect.EnumType {
	return &file_zeta_commands_v1_validator_commands_proto_enumTypes[1]
}
...
func (NodeVote_Type) EnumDescriptor() ([]byte, []int) {
	return file_zeta_commands_v1_validator_commands_proto_rawDescGZIP(), []int{2, 0}
}
...
func (x *ValidatorHeartbeat) Reset() {
	*x = ValidatorHeartbeat{}
	if protoimpl.UnsafeEnabled {
		mi := &file_zeta_commands_v1_validator_commands_proto_msgTypes[0]
...
func (x *ValidatorHeartbeat) GetZetaSignature() *Signature {
	if x != nil {
		return x.ZetaSignature
	}
	return nil
}
...
func (x *AnnounceNode) Reset() {
	*x = AnnounceNode{}
	if protoimpl.UnsafeEnabled {
		mi := &file_zeta_commands_v1_validator_commands_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AnnounceNode) Descriptor() ([]byte, []int) {
	return file_zeta_commands_v1_validator_commands_proto_rawDescGZIP(), []int{1}
}

func (x *AnnounceNode) GetZetaPubKey() string {
	if x != nil {
		return x.ZetaPubKey
	}
	return ""
...
func (x *AnnounceNode) GetZetaPubKeyIndex() uint32 {
	if x != nil {
...
func (x *AnnounceNode) GetZetaSignature() *Signature {
	if x != nil {
		return x.ZetaSignature
	}
	return nil
...
type NodeVote struct {
	...
	Type NodeVote_Type `protobuf:"varint,3,opt,name=type,proto3,enum=zeta.commands.v1.NodeVote_Type" json:"type,omitempty"`
}

func (x *NodeVote) Reset() {
	*x = NodeVote{}
	if protoimpl.UnsafeEnabled {
		mi := &file_zeta_commands_v1_validator_commands_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*NodeVote) Descriptor() ([]byte, []int) {
	return file_zeta_commands_v1_validator_commands_proto_rawDescGZIP(), []int{2}
}
...
// Represents a signature from a validator, to be used by a foreign chain in order to recognise a decision taken by the Zeta network
type NodeSignature struct {
	...
	Kind NodeSignatureKind `protobuf:"varint,3,opt,name=kind,proto3,enum=zeta.commands.v1.NodeSignatureKind" json:"kind,omitempty"`
}

func (x *NodeSignature) Reset() {
	*x = NodeSignature{}
	if protoimpl.UnsafeEnabled {
		mi := &file_zeta_commands_v1_validator_commands_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*NodeSignature) Descriptor() ([]byte, []int) {
	return file_zeta_commands_v1_validator_commands_proto_rawDescGZIP(), []int{3}
}
...
// Event forwarded to the Zeta network to provide information on events happening on other networks
...
func (x *ChainEvent) Reset() {
	*x = ChainEvent{}
	if protoimpl.UnsafeEnabled {
		mi := &file_zeta_commands_v1_validator_commands_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ChainEvent) Descriptor() ([]byte, []int) {
	return file_zeta_commands_v1_validator_commands_proto_rawDescGZIP(), []int{4}
}
...
func (x *ChainEvent) GetBuiltin() *zeta.BuiltinAssetEvent {
...
func (x *ChainEvent) GetErc20() *zeta.ERC20Event {
...
func (x *ChainEvent) GetStakingEvent() *zeta.StakingEvent {
...
func (x *ChainEvent) GetErc20Multisig() *zeta.ERC20MultiSigEvent {
...
type ChainEvent_Builtin struct {
	...
	Builtin *zeta.BuiltinAssetEvent `protobuf:"bytes,1001,opt,name=builtin,proto3,oneof"`
}

type ChainEvent_Erc20 struct {
	// Ethereum ERC20 event.
	Erc20 *zeta.ERC20Event `protobuf:"bytes,1002,opt,name=erc20,proto3,oneof"`
}

type ChainEvent_StakingEvent struct {
	// Ethereum Staking event.
	StakingEvent *zeta.StakingEvent `protobuf:"bytes,1005,opt,name=staking_event,json=stakingEvent,proto3,oneof"`
}

type ChainEvent_Erc20Multisig struct {
	// Ethereum ERC20 multisig event.
	Erc20Multisig *zeta.ERC20MultiSigEvent `protobuf:"bytes,1006,opt,name=erc20_multisig,json=erc20Multisig,proto3,oneof"`
}
...
// Transaction to allow a validator to rotate their Zeta keys
type KeyRotateSubmission struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// New Zeta public key derivation index.
...
func (x *KeyRotateSubmission) Reset() {
	*x = KeyRotateSubmission{}
	if protoimpl.UnsafeEnabled {
		mi := &file_zeta_commands_v1_validator_commands_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*KeyRotateSubmission) Descriptor() ([]byte, []int) {
	return file_zeta_commands_v1_validator_commands_proto_rawDescGZIP(), []int{5}
}
...
func (x *EthereumKeyRotateSubmission) Reset() {
	*x = EthereumKeyRotateSubmission{}
	if protoimpl.UnsafeEnabled {
		mi := &file_zeta_commands_v1_validator_commands_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*EthereumKeyRotateSubmission) Descriptor() ([]byte, []int) {
	return file_zeta_commands_v1_validator_commands_proto_rawDescGZIP(), []int{6}
}
...
type StateVariableProposal struct {
	...
	Proposal *zeta.StateValueProposal `protobuf:"bytes,1,opt,name=proposal,proto3" json:"proposal,omitempty"`
}

func (x *StateVariableProposal) Reset() {
	*x = StateVariableProposal{}
	if protoimpl.UnsafeEnabled {
		mi := &file_zeta_commands_v1_validator_commands_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StateVariableProposal) Descriptor() ([]byte, []int) {
	return file_zeta_commands_v1_validator_commands_proto_rawDescGZIP(), []int{7}
}

func (x *StateVariableProposal) GetProposal() *zeta.StateValueProposal {
	if x != nil {
		return x.Proposal
	}
	return nil
...
func (x *ProtocolUpgradeProposal) Reset() {
	*x = ProtocolUpgradeProposal{}
	if protoimpl.UnsafeEnabled {
		mi := &file_zeta_commands_v1_validator_commands_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProtocolUpgradeProposal) Descriptor() ([]byte, []int) {
	return file_zeta_commands_v1_validator_commands_proto_rawDescGZIP(), []int{8}
}
...
func (x *ProtocolUpgradeProposal) GetZetaReleaseTag() string {
	if x != nil {
...
var File_zeta_commands_v1_validator_commands_proto protoreflect.FileDescriptor

var file_zeta_commands_v1_validator_commands_proto_rawDesc = []byte{
...
var file_zeta_commands_v1_validator_commands_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_zeta_commands_v1_validator_commands_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_zeta_commands_v1_validator_commands_proto_goTypes = []interface{}{
	(NodeSignatureKind)(0),              // 0: zeta.commands.v1.NodeSignatureKind
	(NodeVote_Type)(0),                  // 1: zeta.commands.v1.NodeVote.Type
	(*ValidatorHeartbeat)(nil),          // 2: zeta.commands.v1.ValidatorHeartbeat
	(*AnnounceNode)(nil),                // 3: zeta.commands.v1.AnnounceNode
	(*NodeVote)(nil),                    // 4: zeta.commands.v1.NodeVote
	(*NodeSignature)(nil),               // 5: zeta.commands.v1.NodeSignature
	(*ChainEvent)(nil),                  // 6: zeta.commands.v1.ChainEvent
	(*KeyRotateSubmission)(nil),         // 7: zeta.commands.v1.KeyRotateSubmission
	(*EthereumKeyRotateSubmission)(nil), // 8: zeta.commands.v1.EthereumKeyRotateSubmission
...
func init() { file_zeta_commands_v1_validator_commands_proto_init() }
func file_zeta_commands_v1_validator_commands_proto_init() {
	if File_zeta_commands_v1_validator_commands_proto != nil {
		return
	}
	file_zeta_commands_v1_signature_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_zeta_commands_v1_validator_commands_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_zeta_commands_v1_validator_commands_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_zeta_commands_v1_validator_commands_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_zeta_commands_v1_validator_commands_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_zeta_commands_v1_validator_commands_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_zeta_commands_v1_validator_commands_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_zeta_commands_v1_validator_commands_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_zeta_commands_v1_validator_commands_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_zeta_commands_v1_validator_commands_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
	...
	file_zeta_commands_v1_validator_commands_proto_msgTypes[4].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_zeta_commands_v1_validator_commands_proto_rawDesc,
			NumEnums:      2,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_zeta_commands_v1_validator_commands_proto_goTypes,
		DependencyIndexes: file_zeta_commands_v1_validator_commands_proto_depIdxs,
		EnumInfos:         file_zeta_commands_v1_validator_commands_proto_enumTypes,
		MessageInfos:      file_zeta_commands_v1_validator_commands_proto_msgTypes,
	}.Build()
	File_zeta_commands_v1_validator_commands_proto = out.File
	file_zeta_commands_v1_validator_commands_proto_rawDesc = nil
	file_zeta_commands_v1_validator_commands_proto_goTypes = nil
	file_zeta_commands_v1_validator_commands_proto_depIdxs = nil
}
