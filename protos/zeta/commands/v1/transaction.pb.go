...
// 	protoc        (unknown)
// source: zeta/commands/v1/transaction.proto
...
func (TxVersion) Descriptor() protoreflect.EnumDescriptor {
	return file_zeta_commands_v1_transaction_proto_enumTypes[0].Descriptor()
}

func (TxVersion) Type() protoreflect.EnumType {
	return &file_zeta_commands_v1_transaction_proto_enumTypes[0]
}
...
func (TxVersion) EnumDescriptor() ([]byte, []int) {
	return file_zeta_commands_v1_transaction_proto_rawDescGZIP(), []int{0}
}
...
func (x *InputData) Reset() {
	*x = InputData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_zeta_commands_v1_transaction_proto_msgTypes[0]
...
type Transaction struct {
	...
	Version TxVersion `protobuf:"varint,2000,opt,name=version,proto3,enum=zeta.commands.v1.TxVersion" json:"version,omitempty"`
...
func (x *Transaction) Reset() {
	*x = Transaction{}
	if protoimpl.UnsafeEnabled {
		mi := &file_zeta_commands_v1_transaction_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Transaction) Descriptor() ([]byte, []int) {
	return file_zeta_commands_v1_transaction_proto_rawDescGZIP(), []int{1}
}
...
func (x *ProofOfWork) Reset() {
	*x = ProofOfWork{}
	if protoimpl.UnsafeEnabled {
		mi := &file_zeta_commands_v1_transaction_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProofOfWork) Descriptor() ([]byte, []int) {
	return file_zeta_commands_v1_transaction_proto_rawDescGZIP(), []int{2}
}
...
var File_zeta_commands_v1_transaction_proto protoreflect.FileDescriptor

var file_zeta_commands_v1_transaction_proto_rawDesc = []byte{
...
var file_zeta_commands_v1_transaction_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_zeta_commands_v1_transaction_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_zeta_commands_v1_transaction_proto_goTypes = []interface{}{
	(TxVersion)(0),                         // 0: zeta.commands.v1.TxVersion
	(*InputData)(nil),                      // 1: zeta.commands.v1.InputData
	(*Transaction)(nil),                    // 2: zeta.commands.v1.Transaction
	(*ProofOfWork)(nil),                    // 3: zeta.commands.v1.ProofOfWork
	(*OrderSubmission)(nil),                // 4: zeta.commands.v1.OrderSubmission
	(*OrderCancellation)(nil),              // 5: zeta.commands.v1.OrderCancellation
	(*OrderAmendment)(nil),                 // 6: zeta.commands.v1.OrderAmendment
	(*WithdrawSubmission)(nil),             // 7: zeta.commands.v1.WithdrawSubmission
	(*ProposalSubmission)(nil),             // 8: zeta.commands.v1.ProposalSubmission
	(*VoteSubmission)(nil),                 // 9: zeta.commands.v1.VoteSubmission
	(*LiquidityProvisionSubmission)(nil),   // 10: zeta.commands.v1.LiquidityProvisionSubmission
	...
	(*LiquidityProvisionCancellation)(nil), // 13: zeta.commands.v1.LiquidityProvisionCancellation
	(*LiquidityProvisionAmendment)(nil),    // 14: zeta.commands.v1.LiquidityProvisionAmendment
	(*Transfer)(nil),                       // 15: zeta.commands.v1.Transfer
	(*CancelTransfer)(nil),                 // 16: zeta.commands.v1.CancelTransfer
	(*AnnounceNode)(nil),                   // 17: zeta.commands.v1.AnnounceNode
	(*BatchMarketInstructions)(nil),        // 18: zeta.commands.v1.BatchMarketInstructions
	(*NodeVote)(nil),                       // 19: zeta.commands.v1.NodeVote
	(*NodeSignature)(nil),                  // 20: zeta.commands.v1.NodeSignature
	(*ChainEvent)(nil),                     // 21: zeta.commands.v1.ChainEvent
	(*KeyRotateSubmission)(nil),            // 22: zeta.commands.v1.KeyRotateSubmission
	(*StateVariableProposal)(nil),          // 23: zeta.commands.v1.StateVariableProposal
	(*ValidatorHeartbeat)(nil),             // 24: zeta.commands.v1.ValidatorHeartbeat
	(*EthereumKeyRotateSubmission)(nil),    // 25: zeta.commands.v1.EthereumKeyRotateSubmission
	(*ProtocolUpgradeProposal)(nil),        // 26: zeta.commands.v1.ProtocolUpgradeProposal
	(*IssueSignatures)(nil),                // 27: zeta.commands.v1.IssueSignatures
	(*OracleDataSubmission)(nil),           // 28: zeta.commands.v1.OracleDataSubmission
...
func init() { file_zeta_commands_v1_transaction_proto_init() }
func file_zeta_commands_v1_transaction_proto_init() {
	if File_zeta_commands_v1_transaction_proto != nil {
		return
	}
	file_zeta_commands_v1_commands_proto_init()
	file_zeta_commands_v1_data_proto_init()
	file_zeta_commands_v1_signature_proto_init()
	file_zeta_commands_v1_validator_commands_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_zeta_commands_v1_transaction_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_zeta_commands_v1_transaction_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_zeta_commands_v1_transaction_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	file_zeta_commands_v1_transaction_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	file_zeta_commands_v1_transaction_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_zeta_commands_v1_transaction_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_zeta_commands_v1_transaction_proto_goTypes,
		DependencyIndexes: file_zeta_commands_v1_transaction_proto_depIdxs,
		EnumInfos:         file_zeta_commands_v1_transaction_proto_enumTypes,
		MessageInfos:      file_zeta_commands_v1_transaction_proto_msgTypes,
	}.Build()
	File_zeta_commands_v1_transaction_proto = out.File
	file_zeta_commands_v1_transaction_proto_rawDesc = nil
	file_zeta_commands_v1_transaction_proto_goTypes = nil
	file_zeta_commands_v1_transaction_proto_depIdxs = nil
}
