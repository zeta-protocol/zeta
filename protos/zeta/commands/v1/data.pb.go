...
// 	protoc        (unknown)
// source: zeta/commands/v1/data.proto
...
func (OracleDataSubmission_OracleSource) Descriptor() protoreflect.EnumDescriptor {
	return file_zeta_commands_v1_data_proto_enumTypes[0].Descriptor()
}

func (OracleDataSubmission_OracleSource) Type() protoreflect.EnumType {
	return &file_zeta_commands_v1_data_proto_enumTypes[0]
}
...
func (OracleDataSubmission_OracleSource) EnumDescriptor() ([]byte, []int) {
	return file_zeta_commands_v1_data_proto_rawDescGZIP(), []int{0, 0}
}
...
type OracleDataSubmission struct {
	...
	Source OracleDataSubmission_OracleSource `protobuf:"varint,1,opt,name=source,proto3,enum=zeta.commands.v1.OracleDataSubmission_OracleSource" json:"source,omitempty"`
...
func (x *OracleDataSubmission) Reset() {
	*x = OracleDataSubmission{}
	if protoimpl.UnsafeEnabled {
		mi := &file_zeta_commands_v1_data_proto_msgTypes[0]
...
func (*OracleDataSubmission) Descriptor() ([]byte, []int) {
	return file_zeta_commands_v1_data_proto_rawDescGZIP(), []int{0}
}
...
var File_zeta_commands_v1_data_proto protoreflect.FileDescriptor

var file_zeta_commands_v1_data_proto_rawDesc = []byte{
	...
	0xe3, 0x01, 0x0a, 0x14, 0x4f, 0x72, 0x61, 0x63, 0x6c, 0x65, 0x44, 0x61, 0x74, 0x61, 0x53, 0x75,
	...
	0x64, 0x0a, 0x0c, 0x4f, 0x72, 0x61, 0x63, 0x6c, 0x65, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12,
	...
	0x0a, 0x19, 0x4f, 0x52, 0x41, 0x43, 0x4c, 0x45, 0x5f, 0x53, 0x4f, 0x55, 0x52, 0x43, 0x45, 0x5f,
	0x4f, 0x50, 0x45, 0x4e, 0x5f, 0x4f, 0x52, 0x41, 0x43, 0x4c, 0x45, 0x10, 0x01, 0x12, 0x16, 0x0a,
	0x12, 0x4f, 0x52, 0x41, 0x43, 0x4c, 0x45, 0x5f, 0x53, 0x4f, 0x55, 0x52, 0x43, 0x45, 0x5f, 0x4a,
	0x53, 0x4f, 0x4e, 0x10, 0x02, 0x42, 0x33, 0x5a, 0x31, 0x63, 0x6f, 0x64, 0x65, 0x2e, 0x76, 0x65,
...
var file_zeta_commands_v1_data_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_zeta_commands_v1_data_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_zeta_commands_v1_data_proto_goTypes = []interface{}{
	(OracleDataSubmission_OracleSource)(0), // 0: zeta.commands.v1.OracleDataSubmission.OracleSource
...
func init() { file_zeta_commands_v1_data_proto_init() }
func file_zeta_commands_v1_data_proto_init() {
	if File_zeta_commands_v1_data_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_zeta_commands_v1_data_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_zeta_commands_v1_data_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_zeta_commands_v1_data_proto_goTypes,
		DependencyIndexes: file_zeta_commands_v1_data_proto_depIdxs,
		EnumInfos:         file_zeta_commands_v1_data_proto_enumTypes,
		MessageInfos:      file_zeta_commands_v1_data_proto_msgTypes,
	}.Build()
	File_zeta_commands_v1_data_proto = out.File
	file_zeta_commands_v1_data_proto_rawDesc = nil
	file_zeta_commands_v1_data_proto_goTypes = nil
	file_zeta_commands_v1_data_proto_depIdxs = nil
}
