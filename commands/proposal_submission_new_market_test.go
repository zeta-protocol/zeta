...
import (
	...
	protoTypes "github.com/zeta-protocol/zeta/protos/zeta"
...
func TestCheckProposalSubmissionForNewMarket(t *testing.T) {
	...
	t.Run("Submitting a future market with trading termination from external source with `zetaprotocol.builtin` key and no public keys fails", testFutureMarketSubmissionWithExternalTradingTerminationBuiltInKeyNoPublicKeyFails)
	t.Run("Submitting a future market with trading settlement from external source with `zetaprotocol.builtin` key and no public keys fails", testFutureMarketSubmissionWithExternalTradingSettlementBuiltInKeyNoPublicKeyFails)
...
// func testNewFutureMarketChangeSubmissionWithInvalidOracleSpecZetaPubkeySignerFails(t *testing.T) {
// 	err := checkProposalSubmission(&commandspb.ProposalSubmission{
// 		Terms: &protoTypes.ProposalTerms{
// 			Change: &protoTypes.ProposalTerms_NewMarket{
// 				NewMarket: &protoTypes.NewMarket{
...
func testNewFutureMarketChangeSubmissionWithoutEitherOracleSpecFails(t *testing.T, oracleSpecName string) {
	...
	if oracleSpecName == "data_source_spec_for_settlement_data" {
		future.DataSourceSpecForTradingTermination = &zetapb.DataSourceDefinition{}
	} else {
		future.DataSourceSpecForSettlementData = &zetapb.DataSourceDefinition{}
	}
				...
				NewMarket: &protoTypes.NewMarket{
					Changes: &protoTypes.NewMarketConfiguration{
						Instrument: &protoTypes.InstrumentConfiguration{
							Product: &protoTypes.InstrumentConfiguration_Future{
								Future: &protoTypes.FutureProduct{
									DataSourceSpecForSettlementData:     &zetapb.DataSourceDefinition{},
									DataSourceSpecForTradingTermination: &zetapb.DataSourceDefinition{},
								},
							},
						},
					},
						...
						NewMarket: &protoTypes.NewMarket{
							Changes: &protoTypes.NewMarketConfiguration{
								Instrument: &protoTypes.InstrumentConfiguration{
									Product: &protoTypes.InstrumentConfiguration_Future{
										Future: &protoTypes.FutureProduct{
											DataSourceSpecForSettlementData: zetapb.NewDataSourceDefinition(
...
func testNewFutureMarketChangeSubmissionWithBadPubKeysOrderAddressFail(t *testing.T) {
						...
						Instrument: &protoTypes.InstrumentConfiguration{
							Product: &protoTypes.InstrumentConfiguration_Future{
								Future: &protoTypes.FutureProduct{
									...
									DataSourceSpecForTradingTermination: zetapb.NewDataSourceDefinition(
										zetapb.DataSourceDefinitionTypeExt,
									).SetOracleConfig(
										&zetapb.DataSourceSpecConfiguration{
											Signers: types.SignersIntoProto(pubKeys),
	...
	assert.Contains(t, err.Get("proposal_submission.terms.change.new_market.changes.instrument.product.future.data_source_spec_for_settlement_data.external.oracle.signers.3"), commands.ErrIsNotValidZetaPubkey)
	...
	assert.Contains(t, err.Get("proposal_submission.terms.change.new_market.changes.instrument.product.future.data_source_spec_for_settlement_data.external.oracle.signers.1"), commands.ErrIsNotValidZetaPubkey)
	assert.Contains(t, err.Get("proposal_submission.terms.change.new_market.changes.instrument.product.future.data_source_spec_for_settlement_data.external.oracle.signers.0"), commands.ErrIsNotValidZetaPubkey)
}
...
func testNewFutureMarketChangeSubmissionWithGoodPubKeysOrderAddressSucceed(t *testing.T) {
	...
	assert.NotContains(t, err.Get("proposal_submission.terms.change.new_market.changes.instrument.product.future.data_source_spec_for_settlement_data.external.oracle.signers.0"), commands.ErrIsNotValidZetaPubkey)
}
					...
					Changes: &protoTypes.NewMarketConfiguration{
						Instrument: &protoTypes.InstrumentConfiguration{
							Product: &protoTypes.InstrumentConfiguration_Future{
								Future: &protoTypes.FutureProduct{
									DataSourceSpecForTradingTermination: zetapb.NewDataSourceDefinition(
										zetapb.DataSourceDefinitionTypeInt,
									).SetOracleConfig(
										&zetapb.DataSourceSpecConfiguration{
											Signers: []*datapb.Signer{},
											Filters: []*datapb.Filter{
									...
									DataSourceSpecForSettlementData: zetapb.NewDataSourceDefinition(
										...
										&zetapb.DataSourceSpecConfiguration{
											...
											Filters: []*datapb.Filter{
												{
													Key: &datapb.PropertyKey{
														Name: "zetaprotocol.builtin.prices.ETH.value",
														Type: datapb.PropertyKey_TYPE_INTEGER,
													},
													Conditions: []*datapb.Condition{
														{
