...
func testAnnounceNodeWithEmptySignaturesFails(t *testing.T) {
	...
	assert.Contains(t, err.Get("announce_node.zeta_signature"), commands.ErrIsRequired)
}
...
func testAnnounceNodeWithNonhexSignaturesFails(t *testing.T) {
	...
	assert.Contains(t, err.Get("announce_node.zeta_signature.value"), commands.ErrShouldBeHexEncoded)
}
