...
// ZetaTime and Quantity will always be set. The others will be nil unless when
...
func (ledgerEntries *AggregatedLedgerEntry) ToProto() *v2.AggregatedLedgerEntry {
	...
	lep.Timestamp = ledgerEntries.ZetaTime.UnixNano()

	if ledgerEntries.TransferType != nil {
		lep.TransferType = zeta.TransferType(*ledgerEntries.TransferType)
	}
