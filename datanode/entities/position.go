...
func (p Position) ToProto() *zeta.Position {
	...
	return &zeta.Position{
		...
		PositionStatus:          zeta.PositionStatus(p.DistressedStatus),
	}
}
...
func (p Position) Key() PositionKey {
	return PositionKey{p.MarketID, p.PartyID, p.ZetaTime}
}
...
func (p Position) ToRow() []interface{} {
	return []interface{}{
		...
		p.AverageEntryPrice, p.AverageEntryMarketPrice, p.Loss, p.Adjustment, p.TxHash, p.ZetaTime, p.PendingOpenVolume,
