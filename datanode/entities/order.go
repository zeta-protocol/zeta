...
func (o Order) ToProto() *zeta.Order {
	var peggedOrder *zeta.PeggedOrder
	if o.PeggedReference != types.PeggedReferenceUnspecified {
		peggedOrder = &zeta.PeggedOrder{
...
func (o Order) Key() OrderKey {
	return OrderKey{o.ID, o.Version, o.ZetaTime}
}
...
func (o Order) ToRow() []interface{} {
	return []interface{}{
		...
		o.TxHash, o.ZetaTime, o.SeqNum, o.PostOnly, o.ReduceOnly,
	}
}
