...
import (
	...
	"github.com/zeta-protocol/zeta/datanode/gateway/rest"
	libhttp "github.com/zeta-protocol/zeta/libs/http"
...
func (srv *Server) Start(ctx context.Context) error {
	...
	tlsConfig, err := gateway.GenerateTlsConfig(srv.cfg, srv.zetaPaths)
	if err != nil {
