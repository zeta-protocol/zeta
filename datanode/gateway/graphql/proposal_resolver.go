...
func (r *proposalResolver) RejectionReason(_ context.Context, data *types.GovernanceData) (*zeta.ProposalError, error) {
...
func (r *proposalResolver) State(_ context.Context, data *types.GovernanceData) (zeta.Proposal_State, error) {
	if data == nil || data.Proposal == nil {
		return zeta.Proposal_STATE_UNSPECIFIED, ErrInvalidProposal
	}
