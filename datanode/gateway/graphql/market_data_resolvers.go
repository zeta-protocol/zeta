...
func (r *ZetaResolverRoot) MarketDepth() MarketDepthResolver {
	return (*myMarketDepthResolver)(r)
}

func (r *ZetaResolverRoot) ObservableMarketDepth() ObservableMarketDepthResolver {
	return (*myObservableMarketDepthResolver)(r)
}

// MarketDepthUpdate returns the market depth update resolver.
func (r *ZetaResolverRoot) MarketDepthUpdate() MarketDepthUpdateResolver {
	return (*myMarketDepthUpdateResolver)(r)
}

func (r *ZetaResolverRoot) ObservableMarketDepthUpdate() ObservableMarketDepthUpdateResolver {
	return (*myObservableMarketDepthUpdateResolver)(r)
}

// MarketData returns the market data resolver.
func (r *ZetaResolverRoot) MarketData() MarketDataResolver {
	return (*myMarketDataResolver)(r)
}

func (r *ZetaResolverRoot) ObservableMarketData() ObservableMarketDataResolver {
	return (*myObservableMarketDataResolver)(r)
}

// BEGIN: MarketData resolver

type myMarketDataResolver ZetaResolverRoot
...
func (r *myObservableMarketDataResolver) ExtensionTrigger(ctx context.Context, m *types.MarketData) (zeta.AuctionTrigger, error) {
...
type myMarketDepthResolver ZetaResolverRoot
...
type myMarketDepthUpdateResolver ZetaResolverRoot
