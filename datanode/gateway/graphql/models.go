...
import (
	...
	"github.com/zeta-protocol/zeta/protos/data-node/api/v2"
	"github.com/zeta-protocol/zeta/protos/zeta"
	"github.com/zeta-protocol/zeta/protos/zeta/data/v1"
)
...
// A Zeta builtin asset, mostly for testing purpose
...
// A mode where Zeta tries to execute orders as soon as they are received
...
type DispatchStrategy struct {
	...
	DispatchMetric zeta.DispatchMetric `json:"dispatchMetric"`
...
type ERC20SetAssetLimitsBundle struct {
	...
	ZetaAssetID string `json:"zetaAssetId"`
...
type MarketDataCommitments struct {
	...
	Sells []*zeta.LiquidityOrderReference `json:"sells"`
	// A set of liquidity buy orders to meet the liquidity provision obligation.
	Buys []*zeta.LiquidityOrderReference `json:"buys"`
}
...
type OrderEstimate struct {
	...
	MarginLevels *zeta.MarginLevels `json:"marginLevels"`
}

// Basic description of an order
type OrderInfo struct {
	// Whether the order is to buy or sell
	Side zeta.Side `json:"side"`
	// Price for the order
	Price string `json:"price"`
...
type RewardSummaryEdge struct {
	// The reward summary
	Node *zeta.RewardSummary `json:"node"`
...
type TradeFee struct {
	...
	// The infrastructure fee, a fee paid to the validators to maintain the Zeta network
...
type TransferBalance struct {
	...
	Account *zeta.AccountDetails `json:"account"`
...
type TransferResponse struct {
	...
	Transfers []*zeta.LedgerEntry `json:"transfers"`
...
type UpdateInstrumentConfiguration struct {
	...
	Product *zeta.UpdateFutureProduct `json:"product"`
}
...
const (
	// Zeta Time has changed
	BusEventTypeTimeUpdate BusEventType = "TimeUpdate"
	// Collateral has deposited in to this Zeta network via the bridge
	BusEventTypeDeposit BusEventType = "Deposit"
	// Collateral has been withdrawn from this Zeta network via the bridge
