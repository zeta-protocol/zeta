...
import (
	...
	data "github.com/zeta-protocol/zeta/protos/zeta/data/v1"
...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/mocks.go -package mocks github.com/zeta-protocol/zeta/datanode/gateway/graphql CoreProxyServiceClient,TradingDataServiceClientV2
...
func (r *ZetaResolverRoot) ProposalDetail() ProposalDetailResolver {
...
func (r *ZetaResolverRoot) LedgerEntry() LedgerEntryResolver {
	return (*ledgerEntryResolver)(r)
}

func (r *ZetaResolverRoot) ERC20MultiSigSignerAddedBundle() ERC20MultiSigSignerAddedBundleResolver {
	return (*erc20MultiSigSignerAddedBundleResolver)(r)
}

func (r *ZetaResolverRoot) ERC20MultiSigSignerRemovedBundle() ERC20MultiSigSignerRemovedBundleResolver {
...
func (r *epochRewardSummaryResolver) RewardType(_ context.Context, obj *zeta.EpochRewardSummary) (zeta.AccountType, error) {
...
func (r *epochRewardSummaryResolver) Epoch(_ context.Context, obj *zeta.EpochRewardSummary) (int, error) {
...
func (r *aggregatedLedgerEntriesResolver) ZetaTime(_ context.Context, obj *v2.AggregatedLedgerEntry) (int64, error) {
