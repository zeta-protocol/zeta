...
// it would be nice to use go:generate go run github.com/golang/mock/mockgen -destination mocks/networkhistory_service_mock.go -package mocks github.com/zeta-protocol/zeta/datanode/networkhistory NetworkHistory
