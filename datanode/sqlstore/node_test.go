...
func addNodeAnnounced(t *testing.T, ctx context.Context, ps *sqlstore.Node, nodeID entities.NodeID, added bool, epochSeq uint64, zetatime time.Time) {
	t.Helper()
	aux := entities.ValidatorUpdateAux{
		Added:    added,
		EpochSeq: epochSeq,
	}
	err := ps.AddNodeAnnouncedEvent(ctx, nodeID.String(), zetatime, &aux)
	require.NoError(t, err)
}
...
func addPaginationTestNodes(t *testing.T, ctx context.Context, ns *sqlstore.Node) (nodes []entities.Node) {
	...
	addNodeAnnounced(t, ctx, ns, nodes[0].ID, true, 1, nodes[0].ZetaTime)
	addNodeAnnounced(t, ctx, ns, nodes[1].ID, true, 1, nodes[1].ZetaTime)
	addNodeAnnounced(t, ctx, ns, nodes[2].ID, true, 1, nodes[2].ZetaTime)
	addNodeAnnounced(t, ctx, ns, nodes[3].ID, true, 1, nodes[3].ZetaTime)
	addNodeAnnounced(t, ctx, ns, nodes[4].ID, true, 1, nodes[4].ZetaTime)
	addNodeAnnounced(t, ctx, ns, nodes[5].ID, true, 1, nodes[5].ZetaTime)
	addNodeAnnounced(t, ctx, ns, nodes[6].ID, true, 1, nodes[6].ZetaTime)
	addNodeAnnounced(t, ctx, ns, nodes[7].ID, true, 1, nodes[7].ZetaTime)
	addNodeAnnounced(t, ctx, ns, nodes[8].ID, true, 1, nodes[8].ZetaTime)
	addNodeAnnounced(t, ctx, ns, nodes[9].ID, true, 1, nodes[9].ZetaTime)
