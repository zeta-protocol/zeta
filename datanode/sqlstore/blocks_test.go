...
func addTestBlockForTime(t *testing.T, ctx context.Context, bs *sqlstore.Blocks, zetaTime time.Time) entities.Block {
	t.Helper()
	return addTestBlockForHeightAndTime(t, ctx, bs, 2, zetaTime)
}

func addTestBlockForHeightAndTime(t *testing.T, ctx context.Context, bs *sqlstore.Blocks, height int64, zetaTime time.Time) entities.Block {
	t.Helper()
	// Make a block
