...
const (
	sqlRiskFactorColumns = `market_id, short, long, tx_hash, zeta_time`
)
...
values ($1, $2, $3, $4, $5)
on conflict (market_id, zeta_time) do update
set
	short=EXCLUDED.short,
	long=EXCLUDED.long,
	tx_hash=EXCLUDED.tx_hash`, sqlRiskFactorColumns)

	if _, err := rf.Connection.Exec(ctx, query, factor.MarketID, factor.Short, factor.Long, factor.TxHash, factor.ZetaTime); err != nil {
