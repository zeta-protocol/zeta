...
func populateTestRewards(ctx context.Context, t *testing.T, bs *sqlstore.Blocks, ps *sqlstore.Parties, as *sqlstore.Assets, rs *sqlstore.Rewards) {
	...
	rewards := []entities.Reward{
		{
			...
			ZetaTime:       time.Date(2022, 3, 24, 15, 27, 28, 357155000, time.UTC),
			SeqNum:         1,
		},
		{
			PartyID:        partyID,
			...
			ZetaTime:       time.Date(2022, 3, 24, 15, 28, 1, 508305000, time.UTC),
			SeqNum:         1,
		},
		{
			PartyID:        partyID,
			...
			ZetaTime:       time.Date(2022, 3, 24, 15, 28, 8, 168980000, time.UTC),
			SeqNum:         1,
		},
		{
			PartyID:        partyID,
			...
			ZetaTime:       time.Date(2022, 3, 24, 15, 38, 22, 855711000, time.UTC),
			SeqNum:         1,
		},
		{
			PartyID:        partyID,
			...
			ZetaTime:       time.Date(2022, 3, 24, 15, 38, 49, 338318000, time.UTC),
			SeqNum:         1,
		},
		{
			PartyID:        partyID,
			...
			ZetaTime:       time.Date(2022, 3, 24, 15, 39, 9, 595917000, time.UTC),
			SeqNum:         1,
		},
		{
			PartyID:        partyID,
			...
			ZetaTime:       time.Date(2022, 3, 24, 15, 39, 29, 400906000, time.UTC),
			SeqNum:         1,
		},
		{
			PartyID:        partyID,
			...
			ZetaTime:       time.Date(2022, 3, 24, 15, 40, 34, 750010000, time.UTC),
			SeqNum:         1,
		},
		{
			PartyID:        partyID,
			...
			ZetaTime:       time.Date(2022, 3, 24, 16, 9, 52, 556102000, time.UTC),
			SeqNum:         1,
		},
		{
			PartyID:        partyID,
			...
			ZetaTime:       time.Date(2022, 3, 24, 16, 10, 5, 602243000, time.UTC),
			SeqNum:         1,
		},
	}
	...
	for _, reward := range rewards {
		addTestBlockForTime(t, ctx, bs, reward.ZetaTime)
