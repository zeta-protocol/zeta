...
func getTestLiquidityProvision(live bool) []*zeta.LiquidityProvision {
	testres := []*zeta.LiquidityProvision{
		{
			Id:               "deadbeef",
			PartyId:          "deadbaad",
		...
		},
		{
			...
			Buys:             nil,
			Version:          0,
			Status:           zeta.LiquidityProvision_STATUS_PENDING,
			Reference:        "TEST4",
		},
	}
			...
			[]*zeta.LiquidityProvision{
				{
					...
					Buys:             nil,
					Version:          0,
					Status:           zeta.LiquidityProvision_STATUS_STOPPED,
					Reference:        "TEST5",
				},
				{
					Id:               "deadc0ef",
					...
					Buys:             nil,
					Version:          0,
					Status:           zeta.LiquidityProvision_STATUS_CANCELLED,
					Reference:        "TEST6",
				},
			}...)
	}
