...
func HasZetaSchema(ctx context.Context, conn Connection) (bool, error) {
...
func RecreateZetaDatabase(ctx context.Context, log *logging.Logger, connConfig ConnectionConfig) error {
