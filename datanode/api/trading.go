...
// CoreServiceClient ...
//
//go:generate go run github.com/golang/mock/mockgen -destination mocks/core_service_client_mock.go -package mocks github.com/zeta-protocol/zeta/datanode/api CoreServiceClient
