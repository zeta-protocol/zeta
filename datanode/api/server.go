...
import (
	...
	"github.com/zeta-protocol/zeta/datanode/ratelimit"

	"github.com/zeta-protocol/zeta/core/events"
	"github.com/zeta-protocol/zeta/datanode/candlesv2"
	"github.com/zeta-protocol/zeta/datanode/contextutil"
	...
	protoapi "github.com/zeta-protocol/zeta/protos/data-node/api/v2"
...
// EventService ...
//
//go:generate go run github.com/golang/mock/mockgen -destination mocks/event_service_mock.go -package mocks github.com/zeta-protocol/zeta/datanode/api EventService
...
// BlockService ...
//
//go:generate go run github.com/golang/mock/mockgen -destination mocks/block_service_mock.go -package mocks github.com/zeta-protocol/zeta/datanode/api BlockService
...
//
// it would be nice to use go:generate go run github.com/golang/mock/mockgen -destination mocks/networkhistory_service_mock.go -package mocks github.com/zeta-protocol/zeta/datanode/api NetworkHistoryService
