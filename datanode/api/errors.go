...
var (
	...
	// ErrNotAValidZetaID signals an invalid id.
	ErrNotAValidZetaID = newInvalidArgumentError("not a valid zeta id")
	...
	// ErrInvalidWithdrawalID is returned when the withdrawal ID is not a valid zeta ID.
...
// API errors and Zeta API specific numeric codes.
