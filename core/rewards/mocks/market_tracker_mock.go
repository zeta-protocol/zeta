...
// Source: github.com/zeta-protocol/zeta/core/rewards (interfaces: MarketActivityTracker)
...
func (m *MockMarketActivityTracker) GetFeePartyScores(arg0 string, arg1 zeta.TransferType) []*types.PartyContibutionScore {
	m.ctrl.T.Helper()
