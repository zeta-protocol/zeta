...
import (
	...
	"github.com/zeta-protocol/zeta/core/rewards/mocks"
...
func testCalculateRewards(t *testing.T) {
	...
	engine := testEngine.engine
	engine.UpdateAssetForStakingAndDelegation(context.Background(), "ZETA")
	...
	rewardAccount, err := testEngine.collateral.GetGlobalRewardAccount("ZETA")
...
func testDistributePayout(t *testing.T) {
	...
	partyAccount, err := testEngine.collateral.GetPartyGeneralAccount("party1", "ZETA")
	require.Nil(t, err)
...
func testOnEpochEventNoPayoutDelay(t *testing.T) {
	...
	party1Acc, _ := testEngine.collateral.GetPartyGeneralAccount("party1", "ZETA")
	party2Acc, _ := testEngine.collateral.GetPartyGeneralAccount("party2", "ZETA")
	node1Acc, _ := testEngine.collateral.GetPartyGeneralAccount("node1", "ZETA")
	node2Acc, _ := testEngine.collateral.GetPartyGeneralAccount("node2", "ZETA")
	node3Acc, _ := testEngine.collateral.GetPartyGeneralAccount("node3", "ZETA")
	node4Acc, _ := testEngine.collateral.GetPartyGeneralAccount("node4", "ZETA")
