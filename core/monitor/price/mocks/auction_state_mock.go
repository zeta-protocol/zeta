...
// Source: github.com/zeta-protocol/zeta/core/monitor/price (interfaces: AuctionState)
...
func (m *MockAuctionState) Mode() zeta.Market_TradingMode {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Mode")
	ret0, _ := ret[0].(zeta.Market_TradingMode)
	return ret0
}
