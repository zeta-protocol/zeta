...
// Source: github.com/zeta-protocol/zeta/core/risk (interfaces: Orderbook,AuctionState,TimeService,StateVarEngine,Model)
...
func (m *MockOrderbook) GetCloseoutPrice(arg0 uint64, arg1 zeta.Side) (*num.Uint, error) {
	m.ctrl.T.Helper()
