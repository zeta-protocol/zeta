...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/open_interest_calculator_mock.go -package mocks github.com/zeta-protocol/zeta/core/liquidity/target OpenInterestCalculator
