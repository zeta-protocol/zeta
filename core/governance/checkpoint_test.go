...
func marshalProposal(t *testing.T, proposal *zetapb.Proposal) []byte {
	t.Helper()
	proposals := &checkpointpb.Proposals{
		Proposals: []*zetapb.Proposal{proposal},
	}
