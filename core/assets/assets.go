...
import (
	...
	"github.com/zeta-protocol/zeta/core/assets/builtin"
	"github.com/zeta-protocol/zeta/core/assets/erc20"
	"github.com/zeta-protocol/zeta/core/broker"
	"github.com/zeta-protocol/zeta/core/events"
	nweth "github.com/zeta-protocol/zeta/core/nodewallets/eth"
...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/mocks.go -package mocks github.com/zeta-protocol/zeta/core/assets ERC20BridgeView,Notary
...
func (s *Service) Enable(ctx context.Context, assetID string) error {
	...
	if asset.IsERC20() {
		eth, _ := asset.ERC20()
		s.ethToZeta[eth.ProtoAsset().GetDetails().GetErc20().GetContractAddress()] = assetID
	}
...
func (s *Service) GetZetaIDFromEthereumAddress(address string) string {
	s.amu.Lock()
	defer s.amu.Unlock()
	return s.ethToZeta[address]
}
