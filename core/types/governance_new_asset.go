...
func (a ProposalTermsNewAsset) IntoProto() *zetapb.ProposalTerms_NewAsset {
	var newAsset *zetapb.NewAsset
	if a.NewAsset != nil {
		newAsset = a.NewAsset.IntoProto()
	}
	return &zetapb.ProposalTerms_NewAsset{
		NewAsset: newAsset,
	}
}
...
func NewNewAssetFromProto(p *zetapb.ProposalTerms_NewAsset) (*ProposalTermsNewAsset, error) {
...
func (n NewAsset) IntoProto() *zetapb.NewAsset {
	var changes *zetapb.AssetDetails
	if n.Changes != nil {
		changes = n.Changes.IntoProto()
	}
	return &zetapb.NewAsset{
		Changes: changes,
	}
}
