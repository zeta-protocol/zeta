...
func GenerateWallet(zetaPaths paths.Paths, passphrase string) (*WalletGenerationResult, error) {
	ctx := context.Background()

	walletsHome, err := zetaPaths.CreateDataDirFor(paths.FaucetWalletsDataHome)
	if err != nil {
...
func loadWallet(zetaPaths paths.Paths, walletName, passphrase string) (*faucetWallet, error) {
	ctx := context.Background()
