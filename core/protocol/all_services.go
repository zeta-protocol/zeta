...
import (
	...
	"github.com/zeta-protocol/zeta/libs/subscribers"

	"github.com/zeta-protocol/zeta/core/assets"
	"github.com/zeta-protocol/zeta/core/banking"
	"github.com/zeta-protocol/zeta/core/blockchain"
	"github.com/zeta-protocol/zeta/core/blockchain/abci"
	"github.com/zeta-protocol/zeta/core/blockchain/nullchain"
	"github.com/zeta-protocol/zeta/core/bridges"
	"github.com/zeta-protocol/zeta/core/broker"
	"github.com/zeta-protocol/zeta/core/checkpoint"
	ethclient "github.com/zeta-protocol/zeta/core/client/eth"
	"github.com/zeta-protocol/zeta/core/collateral"
	"github.com/zeta-protocol/zeta/core/config"
	"github.com/zeta-protocol/zeta/core/delegation"
	"github.com/zeta-protocol/zeta/core/epochtime"
	"github.com/zeta-protocol/zeta/core/evtforward"
	"github.com/zeta-protocol/zeta/core/execution"
	"github.com/zeta-protocol/zeta/core/genesis"
	"github.com/zeta-protocol/zeta/core/governance"
	"github.com/zeta-protocol/zeta/core/limits"
	"github.com/zeta-protocol/zeta/core/netparams"
	"github.com/zeta-protocol/zeta/core/netparams/checks"
	"github.com/zeta-protocol/zeta/core/netparams/dispatch"
	"github.com/zeta-protocol/zeta/core/nodewallets"
	"github.com/zeta-protocol/zeta/core/notary"
	"github.com/zeta-protocol/zeta/core/oracles"
	"github.com/zeta-protocol/zeta/core/oracles/adaptors"
	oracleAdaptors "github.com/zeta-protocol/zeta/core/oracles/adaptors"
	"github.com/zeta-protocol/zeta/core/pow"
	"github.com/zeta-protocol/zeta/core/processor"
	"github.com/zeta-protocol/zeta/core/protocolupgrade"
	"github.com/zeta-protocol/zeta/core/rewards"
	"github.com/zeta-protocol/zeta/core/snapshot"
	"github.com/zeta-protocol/zeta/core/spam"
	"github.com/zeta-protocol/zeta/core/staking"
	"github.com/zeta-protocol/zeta/core/statevar"
	...
	"github.com/zeta-protocol/zeta/core/validators/erc20multisig"
...
func newServices(
	...
	svcs.timeService = zetatime.New(svcs.conf.Time, svcs.broker)
	...
	if svcs.conf.IsValidator() {
		...
		svcs.commander, err = nodewallets.NewCommander(
			svcs.conf.NodeWallet, svcs.log, blockchainClient, nodeWallets.Zeta, svcs.stats)
		if err != nil {
			return nil, err
		}
	}
	...
	svcs.snapshot, err = snapshot.New(svcs.ctx, svcs.zetaPaths, svcs.conf.Snapshot, svcs.log, svcs.timeService, svcs.stats.Blockchain)
	if err != nil {
