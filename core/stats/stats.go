...
// GetChainVersion returns the version of the chain in use by zeta.
func (s *Stats) GetChainVersion() string {
	return s.chainVersion
}

// GetVersion return the version of zeta which is currently running.
func (s *Stats) GetVersion() string {
	return s.version
}

// GetVersionHash return the hash of the commit this zeta
