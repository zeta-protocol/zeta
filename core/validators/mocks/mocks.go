...
// Source: github.com/zeta-protocol/zeta/core/validators (interfaces: NodeWallets,TimeService,Commander,ValidatorTopology,Wallet,ValidatorPerformance,Notary,Signatures,MultiSigTopology)
...
import (
	...
	txn "github.com/zeta-protocol/zeta/core/txn"
	validators "github.com/zeta-protocol/zeta/core/validators"
	crypto "github.com/zeta-protocol/zeta/libs/crypto"
	v1 "github.com/zeta-protocol/zeta/protos/zeta/commands/v1"
	v10 "github.com/zeta-protocol/zeta/protos/zeta/snapshot/v1"
...
// GetZeta mocks base method.
func (m *MockNodeWallets) GetZeta() validators.Wallet {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetZeta")
	ret0, _ := ret[0].(validators.Wallet)
	return ret0
}

// GetZeta indicates an expected call of GetZeta.
func (mr *MockNodeWalletsMockRecorder) GetZeta() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetZeta", reflect.TypeOf((*MockNodeWallets)(nil).GetZeta))
}
...
// AllZetaPubKeys mocks base method.
func (m *MockValidatorTopology) AllZetaPubKeys() []string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AllZetaPubKeys")
	ret0, _ := ret[0].([]string)
	return ret0
}

// AllZetaPubKeys indicates an expected call of AllZetaPubKeys.
func (mr *MockValidatorTopologyMockRecorder) AllZetaPubKeys() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AllZetaPubKeys", reflect.TypeOf((*MockValidatorTopology)(nil).AllZetaPubKeys))
}
...
func (mr *MockValidatorTopologyMockRecorder) IsValidatorZetaPubKey(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsValidatorZetaPubKey", reflect.TypeOf((*MockValidatorTopology)(nil).IsValidatorZetaPubKey), arg0)
}

// SelfZetaPubKey mocks base method.
func (m *MockValidatorTopology) SelfZetaPubKey() string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SelfZetaPubKey")
	ret0, _ := ret[0].(string)
	return ret0
}
...
func (mr *MockValidatorTopologyMockRecorder) SelfZetaPubKey() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SelfZetaPubKey", reflect.TypeOf((*MockValidatorTopology)(nil).SelfZetaPubKey))
}
