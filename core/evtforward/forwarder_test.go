...
import (
	...
	"github.com/zeta-protocol/zeta/core/evtforward/mocks"
...
var (
	testSelfZetaPubKey = "self-pubkey"
...
func getTestEvtFwd(t *testing.T) *testEvtFwd {
	...
	top.EXPECT().SelfNodeID().AnyTimes().Return(testSelfZetaPubKey)
