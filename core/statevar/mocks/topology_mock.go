...
// Source: github.com/zeta-protocol/zeta/core/statevar (interfaces: Topology)
...
func (mr *MockTopologyMockRecorder) IsValidatorZetaPubKey(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsValidatorZetaPubKey", reflect.TypeOf((*MockTopology)(nil).IsValidatorZetaPubKey), arg0)
}
