...
import (
	...
	"github.com/zeta-protocol/zeta/core/nodewallets/zeta"
	"github.com/zeta-protocol/zeta/core/txn"
	"github.com/zeta-protocol/zeta/logging"
	api "github.com/zeta-protocol/zeta/protos/zeta/api/v1"
...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/chain_mock.go -package mocks github.com/zeta-protocol/zeta/core/nodewallets Chain
...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/blockchain_stats_mock.go -package mocks github.com/zeta-protocol/zeta/core/nodewallets BlockchainStats
...
func NewCommander(cfg Config, log *logging.Logger, bc Chain, w *zeta.Wallet, bstats BlockchainStats) (*Commander, error) {
