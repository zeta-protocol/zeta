...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/rpc_client_mock.go -package mocks github.com/zeta-protocol/zeta/core/nodewallets/eth/clef Client
