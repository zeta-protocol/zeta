...
// OracleEngine ...
//
//go:generate go run github.com/golang/mock/mockgen -destination mocks/oracle_engine_mock.go -package mocks github.com/zeta-protocol/zeta/core/products OracleEngine
