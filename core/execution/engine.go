...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/mocks.go -package mocks github.com/zeta-protocol/zeta/core/execution TimeService,Assets,StateVarEngine,Collateral,OracleEngine,EpochEngine
...
func (e *Engine) OnMarketMarginScalingFactorsUpdate(ctx context.Context, v interface{}) error {
	...
	pscalingFactors, ok := v.(*zeta.ScalingFactors)
	if !ok {
