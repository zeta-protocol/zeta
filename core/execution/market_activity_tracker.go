...
func (mt *marketTracker) totalFees(metric zeta.DispatchMetric) *num.Uint {
	switch metric {
	case zeta.DispatchMetric_DISPATCH_METRIC_MAKER_FEES_RECEIVED:
		return mt.totalMakerFeesReceived
	case zeta.DispatchMetric_DISPATCH_METRIC_MAKER_FEES_PAID:
		return mt.totalMakerFeesPaid
	case zeta.DispatchMetric_DISPATCH_METRIC_LP_FEES_RECEIVED:
