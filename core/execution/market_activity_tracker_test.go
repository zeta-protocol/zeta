...
import (
	...
	"github.com/zeta-protocol/zeta/core/execution"
	"github.com/zeta-protocol/zeta/core/integration/stubs"
	snp "github.com/zeta-protocol/zeta/core/snapshot"
	"github.com/zeta-protocol/zeta/core/stats"
	...
	snapshotpb "github.com/zeta-protocol/zeta/protos/zeta/snapshot/v1"
...
func TestMarketTracker(t *testing.T) {
	...
	require.Equal(t, false, tracker.IsMarketEligibleForBonus("market1", "ZETA", []string{}, "zohar"))
	require.Equal(t, false, tracker.IsMarketEligibleForBonus("market2", "ZETA", []string{}, "zohar"))
	...
	require.Equal(t, true, tracker.IsMarketEligibleForBonus("market1", "ZETA", []string{}, "zohar"))
	require.Equal(t, true, tracker.IsMarketEligibleForBonus("market2", "ZETA", []string{}, "zohar"))

	// mark as paid
	tracker.MarkPaidProposer("market1", "ZETA", []string{}, "zohar")
	tracker.MarkPaidProposer("market2", "ZETA", []string{}, "zohar")
	...
	require.Equal(t, true, tracker.IsMarketEligibleForBonus("market1", "ZETA", []string{}, "jeremy"))
	require.Equal(t, true, tracker.IsMarketEligibleForBonus("market2", "ZETA", []string{}, "jeremy"))

	// mark as paid
	tracker.MarkPaidProposer("market1", "ZETA", []string{}, "jeremy")
	tracker.MarkPaidProposer("market2", "ZETA", []string{}, "jeremy")

	require.Equal(t, false, tracker.IsMarketEligibleForBonus("market1", "ZETA", []string{}, "jeremy"))
	require.Equal(t, false, tracker.IsMarketEligibleForBonus("market2", "ZETA", []string{}, "jeremy"))
...
func TestGetMarketsWithEligibleProposer(t *testing.T) {
	...
	require.Equal(t, 0, len(tracker.GetMarketsWithEligibleProposer("asset1", []string{}, "ZETA", "zohar")))
	require.Equal(t, 0, len(tracker.GetMarketsWithEligibleProposer("asset1", []string{"market1"}, "ZETA", "zohar")))
	require.Equal(t, 0, len(tracker.GetMarketsWithEligibleProposer("asset1", []string{"market2"}, "ZETA", "zohar")))
	require.Equal(t, 0, len(tracker.GetMarketsWithEligibleProposer("asset1", []string{"market1", "market2"}, "ZETA", "zohar")))

	// market1 goes above the threshold
	tracker.AddValueTraded("market1", num.NewUint(1000))
	tracker.AddValueTraded("market4", num.NewUint(5001))
	require.Equal(t, 2, len(tracker.GetMarketsWithEligibleProposer("", []string{"market1", "market2", "market3", "market4"}, "ZETA", "zohar")))
	...
	require.Equal(t, 1, len(tracker.GetMarketsWithEligibleProposer("asset1", []string{}, "ZETA", "zohar")))
	assertMarketContributionScore(t, expectedScoreMarket1Full, tracker.GetMarketsWithEligibleProposer("asset1", []string{}, "ZETA", "zohar")[0])
	require.Equal(t, 1, len(tracker.GetMarketsWithEligibleProposer("asset1", []string{"market1"}, "ZETA", "zohar")))
	assertMarketContributionScore(t, expectedScoreMarket1Full, tracker.GetMarketsWithEligibleProposer("asset1", []string{"market1"}, "ZETA", "zohar")[0])
	require.Equal(t, 0, len(tracker.GetMarketsWithEligibleProposer("asset1", []string{"market2"}, "ZETA", "zohar")))
	require.Equal(t, 1, len(tracker.GetMarketsWithEligibleProposer("asset1", []string{"market1", "market2"}, "ZETA", "zohar")))
	assertMarketContributionScore(t, expectedScoreMarket1Full, tracker.GetMarketsWithEligibleProposer("asset1", []string{"market1", "market2"}, "ZETA", "zohar")[0])
	...
	require.Equal(t, 2, len(tracker.GetMarketsWithEligibleProposer("asset1", []string{}, "ZETA", "zohar")))
	assertMarketContributionScore(t, expectedScoreMarket1Half, tracker.GetMarketsWithEligibleProposer("asset1", []string{}, "ZETA", "zohar")[0])
	assertMarketContributionScore(t, expectedScoreMarket2Half, tracker.GetMarketsWithEligibleProposer("asset1", []string{}, "ZETA", "zohar")[1])
	require.Equal(t, 1, len(tracker.GetMarketsWithEligibleProposer("asset1", []string{"market1"}, "ZETA", "zohar")))
	assertMarketContributionScore(t, expectedScoreMarket1Full, tracker.GetMarketsWithEligibleProposer("asset1", []string{"market1"}, "ZETA", "zohar")[0])
	require.Equal(t, 1, len(tracker.GetMarketsWithEligibleProposer("asset1", []string{"market2"}, "ZETA", "zohar")))
	assertMarketContributionScore(t, expectedScoreMarket2Full, tracker.GetMarketsWithEligibleProposer("asset1", []string{"market2"}, "ZETA", "zohar")[0])
	require.Equal(t, 2, len(tracker.GetMarketsWithEligibleProposer("asset1", []string{"market1", "market2"}, "ZETA", "zohar")))
	assertMarketContributionScore(t, expectedScoreMarket1Half, tracker.GetMarketsWithEligibleProposer("asset1", []string{"market1", "market2"}, "ZETA", "zohar")[0])
	assertMarketContributionScore(t, expectedScoreMarket2Half, tracker.GetMarketsWithEligibleProposer("asset1", []string{"market1", "market2"}, "ZETA", "zohar")[1])

	// all asset all markets
	// markets 1, 2, 4
	require.Equal(t, 3, len(tracker.GetMarketsWithEligibleProposer("", []string{}, "ZETA", "zohar")))

	// asset with no markets
	require.Equal(t, 0, len(tracker.GetMarketsWithEligibleProposer("asset3", []string{}, "ZETA", "zohar")))
}
...
func TestMarketTrackerStateChange(t *testing.T) {
	...
	tracker.AddValueTraded("market1", num.NewUint(1000))
	require.False(t, tracker.IsMarketEligibleForBonus("market1", "ZETA", []string{}, "zohar"))
	require.False(t, tracker.IsMarketEligibleForBonus("market2", "ZETA", []string{}, "zohar"))
...
func TestMarketProposerBonusScenarios(t *testing.T) {
	...
	require.Equal(t, 0, len(tracker.GetMarketsWithEligibleProposer("asset1", []string{}, "ZETA", "zohar")))
	require.Equal(t, 0, len(tracker.GetMarketsWithEligibleProposer("asset2", []string{}, "ZETA", "zohar")))

	// market1 goes above the threshold only it should be eligible
	tracker.AddValueTraded("market1", num.NewUint(5001))
	require.Equal(t, 1, len(tracker.GetMarketsWithEligibleProposer("asset1", []string{"market1", "market2", "market3"}, "ZETA", "zohar")))
	require.True(t, tracker.IsMarketEligibleForBonus("market1", "ZETA", []string{"market1", "market2", "market3"}, "zohar"))
	require.False(t, tracker.IsMarketEligibleForBonus("market2", "ZETA", []string{"market1", "market2", "market3"}, "zohar"))
	require.False(t, tracker.IsMarketEligibleForBonus("market3", "ZETA", []string{"market1", "market2", "market3"}, "zohar"))
	require.False(t, tracker.IsMarketEligibleForBonus("market4", "ZETA", []string{"market1", "market2", "market3"}, "zohar"))
	tracker.MarkPaidProposer("market1", "ZETA", []string{"market1", "market2", "market3"}, "zohar")
	...
	require.Equal(t, 2, len(tracker.GetMarketsWithEligibleProposer("asset1", []string{"market1", "market2", "market3"}, "ZETA", "zohar")))

	// show that only markets 2 and 3 are now eligible with this combo
	require.False(t, tracker.IsMarketEligibleForBonus("market1", "ZETA", []string{"market1", "market2", "market3"}, "zohar"))
	require.True(t, tracker.IsMarketEligibleForBonus("market2", "ZETA", []string{"market1", "market2", "market3"}, "zohar"))
	require.True(t, tracker.IsMarketEligibleForBonus("market3", "ZETA", []string{"market1", "market2", "market3"}, "zohar"))
	require.False(t, tracker.IsMarketEligibleForBonus("market4", "ZETA", []string{"market1", "market2", "market3"}, "zohar"))
	tracker.MarkPaidProposer("market2", "ZETA", []string{"market1", "market2", "market3"}, "zohar")
	tracker.MarkPaidProposer("market3", "ZETA", []string{"market1", "market2", "market3"}, "zohar")

	// now market4 goes above the threshold but no one gets paid by this combo
	tracker.AddValueTraded("market4", num.NewUint(5001))
	require.Equal(t, 0, len(tracker.GetMarketsWithEligibleProposer("asset1", []string{"market1", "market2", "market3"}, "ZETA", "zohar")))
	require.False(t, tracker.IsMarketEligibleForBonus("market1", "ZETA", []string{"market1", "market2", "market3"}, "zohar"))
	require.False(t, tracker.IsMarketEligibleForBonus("market2", "ZETA", []string{"market1", "market2", "market3"}, "zohar"))
	require.False(t, tracker.IsMarketEligibleForBonus("market3", "ZETA", []string{"market1", "market2", "market3"}, "zohar"))
	require.False(t, tracker.IsMarketEligibleForBonus("market4", "ZETA", []string{"market1", "market2", "market3"}, "zohar"))
	...
	require.Equal(t, 4, len(tracker.GetMarketsWithEligibleProposer("asset1", []string{}, "ZETA", "zohar")))
	require.True(t, tracker.IsMarketEligibleForBonus("market1", "ZETA", []string{}, "zohar"))
	require.True(t, tracker.IsMarketEligibleForBonus("market2", "ZETA", []string{}, "zohar"))
	require.True(t, tracker.IsMarketEligibleForBonus("market3", "ZETA", []string{}, "zohar"))
	require.True(t, tracker.IsMarketEligibleForBonus("market4", "ZETA", []string{}, "zohar"))

	tracker.MarkPaidProposer("market1", "ZETA", []string{}, "zohar")
	tracker.MarkPaidProposer("market2", "ZETA", []string{}, "zohar")
	tracker.MarkPaidProposer("market3", "ZETA", []string{}, "zohar")
	tracker.MarkPaidProposer("market4", "ZETA", []string{}, "zohar")
	...
	require.False(t, tracker.IsMarketEligibleForBonus("market1", "ZETA", []string{}, "zohar"))
	require.False(t, tracker.IsMarketEligibleForBonus("market2", "ZETA", []string{}, "zohar"))
	require.False(t, tracker.IsMarketEligibleForBonus("market3", "ZETA", []string{}, "zohar"))
	require.False(t, tracker.IsMarketEligibleForBonus("market4", "ZETA", []string{}, "zohar"))
	require.True(t, tracker.IsMarketEligibleForBonus("market7", "ZETA", []string{}, "zohar"))
	tracker.MarkPaidProposer("market7", "ZETA", []string{}, "zohar")

	// check that they are no longer eligible for this combo of all
	require.Equal(t, 0, len(tracker.GetMarketsWithEligibleProposer("asset1", []string{}, "ZETA", "zohar")))

	// check new combo
	require.Equal(t, 3, len(tracker.GetMarketsWithEligibleProposer("asset1", []string{"market1", "market3", "market7"}, "ZETA", "zohar")))
	require.True(t, tracker.IsMarketEligibleForBonus("market1", "ZETA", []string{"market1", "market3", "market7"}, "zohar"))
	require.False(t, tracker.IsMarketEligibleForBonus("market2", "ZETA", []string{"market1", "market3", "market7"}, "zohar"))
	require.True(t, tracker.IsMarketEligibleForBonus("market3", "ZETA", []string{"market1", "market3", "market7"}, "zohar"))
	require.False(t, tracker.IsMarketEligibleForBonus("market4", "ZETA", []string{"market1", "market3", "market7"}, "zohar"))
	require.True(t, tracker.IsMarketEligibleForBonus("market7", "ZETA", []string{"market1", "market3", "market7"}, "zohar"))

	tracker.MarkPaidProposer("market1", "ZETA", []string{"market1", "market3", "market7"}, "zohar")
	tracker.MarkPaidProposer("market3", "ZETA", []string{"market1", "market3", "market7"}, "zohar")
	tracker.MarkPaidProposer("market7", "ZETA", []string{"market1", "market3", "market7"}, "zohar")

	// now that they're marked as paid check they're no longer eligible
	require.Equal(t, 0, len(tracker.GetMarketsWithEligibleProposer("asset1", []string{"market1", "market3", "market7"}, "ZETA", "zohar")))
	...
	require.Equal(t, 5, len(tracker.GetMarketsWithEligibleProposer("asset1", []string{}, "ZETA", "jeremy")))
	require.True(t, tracker.IsMarketEligibleForBonus("market1", "ZETA", []string{}, "jeremy"))
	require.True(t, tracker.IsMarketEligibleForBonus("market2", "ZETA", []string{}, "jeremy"))
	require.True(t, tracker.IsMarketEligibleForBonus("market3", "ZETA", []string{}, "jeremy"))
	require.True(t, tracker.IsMarketEligibleForBonus("market4", "ZETA", []string{}, "jeremy"))
	require.True(t, tracker.IsMarketEligibleForBonus("market7", "ZETA", []string{}, "jeremy"))

	tracker.MarkPaidProposer("market1", "ZETA", []string{}, "jeremy")
	tracker.MarkPaidProposer("market2", "ZETA", []string{}, "jeremy")
	tracker.MarkPaidProposer("market3", "ZETA", []string{}, "jeremy")
	tracker.MarkPaidProposer("market4", "ZETA", []string{}, "jeremy")
	tracker.MarkPaidProposer("market7", "ZETA", []string{}, "jeremy")
	require.Equal(t, 0, len(tracker.GetMarketsWithEligibleProposer("asset1", []string{}, "ZETA", "jeremy")))
}
