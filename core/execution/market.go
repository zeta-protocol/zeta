...
import (
	...
	liquiditytarget "github.com/zeta-protocol/zeta/core/liquidity/target"
	"github.com/zeta-protocol/zeta/core/markets"
	...
	lmon "github.com/zeta-protocol/zeta/core/monitor/liquidity"
	"github.com/zeta-protocol/zeta/core/monitor/price"
...
// Market represents an instance of a market in zeta and is in charge of calling
...
func (m *Market) OnTick(ctx context.Context, t time.Time) bool {
	...
	_, blockHash := zetacontext.TraceIDFromContext(ctx)
...
func (m *Market) BlockEnd(ctx context.Context) {
	...
	var tID string
	ctx, tID = zetacontext.TraceIDFromContext(ctx)
