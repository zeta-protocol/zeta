...
import (
	...
	"github.com/zeta-protocol/zeta/core/banking/mocks"
...
func testDepositSuccess(t *testing.T) {
	...
	// to do the deposit
	eng.col.EXPECT().Deposit(gomock.Any(), bad.PartyID, bad.ZetaAssetID, bad.Amount).Times(1).Return(&types.LedgerMovement{}, nil)
