...
func TestJSONVPriceMonitoringParameters(t *testing.T) {
	...
	j := netparams.NewJSON(&zeta.PriceMonitoringParameters{}, netparams.PriceMonitoringParametersValidation).Mutable(true).MustUpdate(validPmJSONString)
	assert.NotNil(t, j)
	...
	pm := &zeta.PriceMonitoringParameters{}
