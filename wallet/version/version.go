...
import (
	...
	vgversion "github.com/zeta-protocol/zeta/libs/version"
...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/store_mock.go -package mocks github.com/zeta-protocol/zeta/wallet/version NetworkStore
