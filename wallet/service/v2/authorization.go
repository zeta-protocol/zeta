...
// It is our non-standard scheme that stands for Zeta Wallet Token.
const VWTPrefix = "VWT"

// VWT stands for Zeta Wallet Token. It has the following format:
//
//	VWT <TOKEN>
//
// Example:
...
// ExtractVWT extracts the Zeta Wallet Token from the `Authorization` header.
