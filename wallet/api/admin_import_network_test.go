...
func testImportNetworkWithURL(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name:       "real-url",
			url:        "https://github.com/zetaprotocol/networks-internal/blob/main/fairground/zetawallet-fairground.toml",
			suggestion: "https://raw.githubusercontent.com/zetaprotocol/networks-internal/main/fairground/zetawallet-fairground.toml",
		...
		},
		{
			...
			url:        "https://github.com/zetaprotocol/zeta/issues",
			jsonrpcErr: jsonrpc.ErrorCodeInternalError,
		},
	}
