...
import (
	...
	"github.com/zeta-protocol/zeta/wallet/api/node/adapters"
...
//go:generate go run github.com/golang/mock/mockgen -destination mocks/node_mock.go -package mocks github.com/zeta-protocol/zeta/wallet/api/node GRPCAdapter
...
func (n *RetryingNode) Statistics(ctx context.Context) (nodetypes.Statistics, error) {
	...
	n.log.Debug("response from Statistics",
		...
		zap.String("zeta-time", resp.ZetaTime),
