...
// Generates mocks
//go:generate go run github.com/golang/mock/mockgen -destination mocks/mocks.go -package mocks github.com/zeta-protocol/zeta/wallet/api WalletStore,NetworkStore,Interactor,ConnectionsManager,SpamHandler
