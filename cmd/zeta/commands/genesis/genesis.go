...
type Cmd struct {
	...
	Update         updateCmd         `command:"update" description:"Update the genesis file with the app_state, useful if the genesis generation is not done using \"zeta genesis generate\""`
